...
trainSet = pd.read_csv('runtime_cache/train_split1.csv')
testSet = pd.read_csv('runtime_cache/test_split1.csv')

trainSetFeatures = trainSet.drop(['query_id', 'doc_id', 'label',"query_length"],axis=1).values  # id and relevance is not features to use
...
result_path = "runtime_cache/test_performance_random_forest_split1.txt"
Utilities.outputResult(testSet,predictedLabels,result_path)

result_path = "runtime_cache/train_performance_random_forest_split1.txt"
