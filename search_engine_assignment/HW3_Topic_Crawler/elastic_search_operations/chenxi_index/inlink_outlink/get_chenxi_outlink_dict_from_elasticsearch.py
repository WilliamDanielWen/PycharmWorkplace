...
def get_chenxi_outlinks_info():
    ...
    for rel in scan(es_client, index="maritimeaccidents", doc_type="document", query={"query": {"match_all": {}}}):
    ...
    dump_dict("url_to_id_dict_chenxi.cpkl", url_to_id_dict)
    dump_dict("id_to_url_dict_chenxi.cpkl", id_to_url_dict)
    dump_dict("chenxi_original_outlinks_dict.cpkl",team_outlinks_dict)
