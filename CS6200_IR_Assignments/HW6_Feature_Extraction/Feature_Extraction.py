...
def extract_static_features(DOC_LENGTH_DICT,valid_queries,true_label_set):
...
if __name__=="__main__":
    ...
    # step1
    #IR_Scores=compute_IR_Scores(DOC_LENGTH_DICT,valid_queries, true_label_doc_set)
    #dump_dict("runtime_cache/IR_Scores_dict",IR_Scores)
    ...
    # Data_Set=load_dict("runtime_cache/Data_Set_dict")
