...
train_photo_to_biz = pd.read_csv(data_root+'second_sampled_data_photo_to_biz_ids.csv')
train_labels = pd.read_csv(data_root+'second_sampled_data.csv').dropna()
...
## Load image features
f = h5py.File(data_root+'second_sampled_data_image_fc6features.h5','r')
...
with open(data_root+"second_sampled_data_biz_fc6features.csv",'w') as f:
