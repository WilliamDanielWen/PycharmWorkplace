...
#loop on
def get_fc6_feature(images, layer ='fc6'):
...
# Initialize files
import h5py
f = h5py.File(data_folder_location + 'first_sampled_data_image_fc6features.h5', 'w')
...
for i in range(0, num_train, batch_size):
    ...
    features = get_fc6_feature(images, layer='fc6')
    num_done = i+features.shape[0]
    f= h5py.File(data_folder_location + 'first_sampled_data_image_fc6features.h5', 'r+')
