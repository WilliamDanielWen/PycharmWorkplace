...
# Initialize files
import h5py
f = h5py.File(data_folder_location + 'second_sampled_data_image_fc6features.h5', 'w')
...
for i in range(0, num_train, batch_size):
    ...
    f= h5py.File(data_folder_location + 'second_sampled_data_image_fc6features.h5', 'r+')
